...
# The weighted_sample selection method is disabled due to an issue with numpy
# in uWSGI: https://github.com/numpy/numpy/issues/14384
# This may be a result of uWSGI doing multiple imports in different vassals?
# Or perhaps simply the way modules are initially loaded. In any event, it
# seems unlikely that this incompatibility will be resolved any time soon.
